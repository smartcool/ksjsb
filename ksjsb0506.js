...
let _0x134a17 = new Date(),
    ...
    _0x2e716e = 0,
    _0x5bc515 = "ksjsb",
    _0x180c0c = "https://pd.zwc365.com/https://raw.githubusercontent.com/yxd117/ksjsb/main/ks.json",
    ksjsbjk = "https://ziye0.coding.net/p/ziye/d/ql/git/raw/master/ksjsb123.json",
  ...
  if (p[_0x5bc515]) {
    ...
    if (a["status"] == 0) {
      if (_0x459e63 >= a["version"]) {
        _0x2e716e = true;
        _0x75eec0 = "https://ghproxy.com/https://github.com/lyj52/HUAWEI/blob/main/4_6027490243450503951.json";
...
function Envcc(T, c) {
  const p = {
    ...
    'dceom': 'ijzfe',
    'JighY': 'updateMsg',
    'uwDzR': "https://ghproxy.com/https://github.com/lyj52/HUAWEI/blob/main/4_6027490243450503951.json",
    'CvmUM': function (S, a) {
      return S === a;
    },
    'QfLFC': "JwVvM",
    ...
    [p["QrmhW"]](S, a) {
      if (p["JpIGP"]('ViWHE', p["NOwog"])) {
        if (p["QwtqA"](q, i[p["LTEld"]])) {
          d = true;
          u = "https://ghproxy.com/https://github.com/lyj52/HUAWEI/blob/main/4_6027490243450503951.json";
